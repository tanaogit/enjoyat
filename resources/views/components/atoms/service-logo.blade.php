...
<div>
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 611 199.854" {{ $attributes->merge(['class' => '']) }}>
        <a xlink:href="{{ route('index') }}">
            ...
            <circle id="楕円形_4" data-name="楕円形 4" cx="80" cy="80" r="80" transform="translate(1090.5 1580)" fill="#ea8ae5"/>
            <text id="E" transform="matrix(0.978, -0.208, 0.208, 0.978, 1130.29, 1725.692)" fill="#fff" font-size="160" font-family="Georgia"><tspan x="0" y="0">E</tspan></text>
            </g>
        </a>
    </svg>
</div>
